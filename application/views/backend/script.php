 <!-- javascripts -->
    ...
    <script type="<?php echo base_url("asset2/text/javascript")?>" src="<?php echo base_url("asset2/js/jquery-ui-1.9.2.custom.min.js")?>"></script>
    <!-- bootstrap -->
    ...
    <script src="<?php echo base_url("asset2/js/jquery.nicescroll.js")?>" type="<?php echo base_url("asset2/text/javascript")?>"></script>
    <!-- charts scripts -->
    <script src="<?php echo base_url("asset2/assets/jquery-knob/js/jquery.knob.js")?>"></script>
    <script src="<?php echo base_url("asset2/js/jquery.sparkline.js")?>" type="<?php echo base_url("asset2/text/javascript")?>"></script>
